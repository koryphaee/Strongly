...
class TYPENAMETypeConverter : System.ComponentModel.TypeConverter
{
    ...
    {
        return sourceType == typeof(sbyte) || sourceType == typeof(string) || base.CanConvertFrom(context, sourceType);
    }
    ...
    public override object? ConvertFrom(System.ComponentModel.ITypeDescriptorContext? context, System.Globalization.CultureInfo? culture, object value)
    {
        return value switch
        {
            sbyte byteValue => new TYPENAME(byteValue),
    ...
    {
        return sourceType == typeof(sbyte) || sourceType == typeof(string) || base.CanConvertTo(context, sourceType);
    }
